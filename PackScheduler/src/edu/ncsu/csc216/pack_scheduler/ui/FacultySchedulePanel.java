...
public class FacultySchedulePanel  extends JPanel implements ActionListener {
	...
	/** Border for Schedule */
	private TitledBorder borderSchedule1;
...
//		add(pnlActions, c);
		...
		borderSchedule1 = BorderFactory.createTitledBorder(lowerEtched, "");
		scrollCatalog.setBorder(borderSchedule);
		TitledBorder borderCourseDetails1 = BorderFactory.createTitledBorder(lowerEtched, "Faculty Schedule");
		scrollCatalog.setBorder(borderCourseDetails1);
		scrollCatalog.setToolTipText("Faculty Schedule"); 
		
		TitledBorder borderCourseDetails2 = BorderFactory.createTitledBorder(lowerEtched, "Course Roll");
		scrollSchedule.setBorder(borderCourseDetails2);
		scrollSchedule.setToolTipText("Course Roll"); 
