...
public class CourseTest {
	...
	public void testSetSection() {
		...
		try {
			c.setSection("abc");
			fail("Only digits allowed in section.");
		} catch(IllegalArgumentException e) {
	...
	public void testSetCourseTime() {
		...
		// provided tests.
		Course test1 = new Course("Test123", "Test", "001", 4, "serober7", 120, "A");
		try {
			test1.setActivityTime(1, 1);
			fail();
		} catch (IllegalArgumentException e) {
			assertEquals(test1.getStartTime(), 0);
			assertEquals(test1.getEndTime(), 0);
		}

		try {
			test1.setActivityTime(0, 1);
			fail();
		} catch (IllegalArgumentException e) {
			assertEquals(test1.getStartTime(), 0);
			assertEquals(test1.getEndTime(), 0);
	...
	public void testGetMeetingString() {
		...
		Activity c5 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, "MWF", 0, 30);
		assertEquals("MWF 12:00AM-12:30AM", c5.getMeetingString());
	}
	...
	public void testEqualsObject() {
		...
		Activity c10 = new Course("abc123", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Activity c11 = null;
		...
		// assertFalse(c1.equals(new CourseCatalog("abc"))); no longer applicable b/c
		// loadCourseCatalog retuns void and doesnt thrown any exceptions
	...
	/** Tests whether a course is a duplicate of another */
	@Test
	public void testIsDuplicateCourse() {
		Activity c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Activity c2 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Activity c3 = new Course(NAME, "Different", SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME,
				END_TIME);
		...
		Activity c5 = new Course(NAME, TITLE, SECTION, 5, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Activity c10 = new Course("abc123", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Activity c11 = new Course("abc123", TITLE, "002", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);

		try {
			assertTrue(c1.isDuplicate(c2));
		} catch (IllegalArgumentException e) {
			assertEquals("You are already enrolled in " + ((Course) c1).getName(), e.getMessage());
		}
		...
		assertFalse(c1.equals(c4));
		assertFalse(c1.isDuplicate(c10));
		assertFalse(c1.isDuplicate(c11));
	...
	public void testHashCode() {
		...
		Activity c8 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, 830, END_TIME);
		Activity c9 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, 1400);
		Activity c10 = new Course("ANT252", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
