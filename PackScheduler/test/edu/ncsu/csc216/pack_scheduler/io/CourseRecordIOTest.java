...
public class CourseRecordIOTest {
	...
	/**
	 * Tests the implied CourseRecordIO constructor. This test is purely for
	 * coverage, as all CourseRecordIO methods are static
	 */
	@Test
	public void testCourseRecordIOConstructor() {
		CourseRecordIO cr = new CourseRecordIO();
		assertTrue(cr.getClass().toString().contains("CourseRecordIO"));
	}
